...
All reports export as PDF using QWeb templates.
    ...
    'images': [
        ...
        'images/screenshot_01_general_ledger.png',
        'images/screenshot_02_journal_entry.png',
        'images/screenshot_03_branch_list.png',
        'images/screenshot_04_pl_report.png',
        'images/screenshot_05_wizard.png',
    ],
